    ...
    <section id="desserts" className="py-24 bg-rose-50 text-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }} 
          viewport={{ once: true }} 
          className="mt-16 bg-white/60 backdrop-blur-xl border border-rose-100 p-8 rounded-3xl max-w-3xl mx-auto shadow-sm"
        >
          <div className="text-center">
            <h4 className="text-xl font-bold text-slate-800 mb-2">
              Haz tu pedido a Dulce Encanto
            </h4>
            <p className="text-slate-500 mb-6">Disfruta de nuestros postres y fresas sin salir de tu apartamento.</p>
            <a 
              href="https://wa.me/573169442787" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="inline-flex items-center gap-2 bg-rose-500 hover:bg-rose-600 transition-colors text-white font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-xl"
            >
